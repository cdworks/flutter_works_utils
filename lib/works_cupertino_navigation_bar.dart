...
class WorksCupertinoNavigationBar extends StatefulWidget implements ObstructingPreferredSizeWidget {
  /// Creates a navigation bar in the iOS style.
  const WorksCupertinoNavigationBar({
    Key key,
    this.leading,
    this.isAutoWrapWithBackground = false,
  ...
  final bool isAutoWrapWithBackground;
  ...
  static Widget createBackButton(VoidCallback onPressed)
  {
    return _CupertinoNavigationBarBackButton(
        onPressed: onPressed);
  }
...
class _CupertinoNavigationBarState extends State<WorksCupertinoNavigationBar> {
...
class _PersistentNavigationBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (leading == null && backChevron != null && backLabel != null) {
      leading = _CupertinoNavigationBarBackButton._assemble(
        backChevron,
        backLabel,
      );
    }
...
class _CupertinoNavigationBarBackButton extends StatelessWidget {
  /// Construct a [CupertinoNavigationBarBackButton] that can be used to pop
  /// the current route.
  ///
  /// The [color] parameter must not be null.
  const _CupertinoNavigationBarBackButton({
    Key key,
    this.color,
    this.previousPageTitle,
    this.onPressed,
  ...
  const _CupertinoNavigationBarBackButton._assemble(
      this._backChevron,
      this._backLabel,
      {this.onPressed}
