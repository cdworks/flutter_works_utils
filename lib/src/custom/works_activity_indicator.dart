...
class WorksCupertinoActivityIndicator extends StatefulWidget {
  /// Creates an iOS-style activity indicator that spins clockwise.
  const WorksCupertinoActivityIndicator({
    Key key,
    this.animating = true,
...
class _CupertinoActivityIndicatorState extends State<WorksCupertinoActivityIndicator> with SingleTickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(WorksCupertinoActivityIndicator oldWidget) {
